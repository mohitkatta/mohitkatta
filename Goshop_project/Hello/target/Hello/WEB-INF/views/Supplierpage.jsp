...
<body>
<c:url value="/addsupplier" var="supurl"></c:url>
...
<div class="form-group row">
    <form:label path="supplier_id"><b>Supplier Id</b></form:label>
    <form:input path="supplier_id" type="supplier id" class="form-control" placeholder="" name="Supplier Id" required="true"/><br>
</div>
