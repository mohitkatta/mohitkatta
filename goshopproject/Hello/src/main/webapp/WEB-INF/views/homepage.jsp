...
<div class="container">
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      ...
      <div class="item">
        <img src="<c:url value="/resources/images/bikeaccessories.jpg"/>" alt="" width="460" height="345">
        <div class="carousel-caption">
          <h3>Offers</h3>
       ...
       <div class="item">
        <img src="<c:url value="/resources/images/furnitures.jpg"/>" alt="" width="460" height="345">
        <div class="carousel-caption">
          <h3>Offers</h3>
          <p>Mega offers online in different categories.</p>
        </div>
      ...
      <div class="item">
        <img src="<c:url value="/resources/images/smartphone.jpg"/>" alt="" width="460" height="345">
        <div class="carousel-caption">
          <h3>Offers</h3>
          <p>Mega offers online in different categories.</p>
        </div>
       ...
       <div class="item">
        <img src="<c:url value="/resources/images/homeappliances.jpg"/>" alt="" width="460" height="345">
        <div class="carousel-caption">
        <p>Shop now...2 days moree</p>
          </div>
      </div>
       ...
       <div class="item">
        <img src="<c:url value="/resources/images/beautyproducts.jpg"/>" alt="" width="460" height="345">
        <div class="carousel-caption">
        <p>Shop now...2 days moree</p>
          </div>
      </div>
